...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PgTestUserConfig) DeepCopyInto(out *PgTestUserConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PgTestUserConfig.
func (in *PgTestUserConfig) DeepCopy() *PgTestUserConfig {
	if in == nil {
		return nil
	}
	out := new(PgTestUserConfig)
	in.DeepCopyInto(out)
	return out
}

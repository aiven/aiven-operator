...
The Aiven Operator project accepts contributions via GitHub pull requests. This document outlines the process
to help get your contribution accepted.

Please see also the Aiven Operator [Developer Guide](./developer-guide).
...
method for tracking anything to do with the Aiven Operator project.

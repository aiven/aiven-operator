...
- [`consumer_fetch_max_bytes`](#spec.kafkaMirrormaker.kafka_mirrormaker.consumer_fetch_max_bytes-property){: name='spec.kafkaMirrormaker.kafka_mirrormaker.consumer_fetch_max_bytes-property'} (integer, Minimum: 0, Maximum: 104857600). The maximum amount of data the server should return for a fetch request.
...
- [`consumer_receive_buffer_bytes`](#spec.kafkaMirrormaker.kafka_mirrormaker.consumer_receive_buffer_bytes-property){: name='spec.kafkaMirrormaker.kafka_mirrormaker.consumer_receive_buffer_bytes-property'} (integer, Minimum: -1, Maximum: 104857600). The size of the TCP receive buffer (SO_RCVBUF) to use when reading data. -1 uses the OS default.
- [`consumer_request_timeout_ms`](#spec.kafkaMirrormaker.kafka_mirrormaker.consumer_request_timeout_ms-property){: name='spec.kafkaMirrormaker.kafka_mirrormaker.consumer_request_timeout_ms-property'} (integer, Minimum: 0, Maximum: 600000). The maximum time the client will wait for a response to a request.
...
- [`producer_request_timeout_ms`](#spec.kafkaMirrormaker.kafka_mirrormaker.producer_request_timeout_ms-property){: name='spec.kafkaMirrormaker.kafka_mirrormaker.producer_request_timeout_ms-property'} (integer, Minimum: 0, Maximum: 600000). The maximum time the client will wait for a response to a request.
- [`producer_send_buffer_bytes`](#spec.kafkaMirrormaker.kafka_mirrormaker.producer_send_buffer_bytes-property){: name='spec.kafkaMirrormaker.kafka_mirrormaker.producer_send_buffer_bytes-property'} (integer, Minimum: -1, Maximum: 104857600). The size of the TCP send buffer (SO_SNDBUF) to use when sending data. -1 uses the OS default.

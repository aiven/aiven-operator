...
| ----------- | ----------- |
| [ServiceClickHouseDatabaseCreate](https://api.aiven.io/doc/#operation/ServiceClickHouseDatabaseCreate) | `service:data:write` |
| [ServiceClickHouseDatabaseDelete](https://api.aiven.io/doc/#operation/ServiceClickHouseDatabaseDelete) | `service:data:write` |
| [ServiceClickHouseDatabaseList](https://api.aiven.io/doc/#operation/ServiceClickHouseDatabaseList) | `service:data:write` |

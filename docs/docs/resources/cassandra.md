...
- [`cassandra_version`](#spec.userConfig.cassandra_version-property){: name='spec.userConfig.cassandra_version-property'} (string, Pattern: `^[0-9]+(\.[0-9]+)?$`). Available versions: `4.1`. Newer versions may also be available.

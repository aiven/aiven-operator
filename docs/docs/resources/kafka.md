...
- [`karapace_version`](#spec.userConfig.karapace_version-property){: name='spec.userConfig.karapace_version-property'} (string). Available versions: `6.2.1`, `6.2.2`. Newer versions may also be available.

...
- [`userConfig`](#spec.userConfig-property){: name='spec.userConfig-property'} (object). Grafana specific user configuration options. See below for [nested schema](#spec.userConfig).

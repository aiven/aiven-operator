...
| ----------- | ----------- |
| [ProjectDelete](https://api.aiven.io/doc/#operation/ProjectDelete) | `organization:projects:write` |
| [ProjectGet](https://api.aiven.io/doc/#operation/ProjectGet) | `project:services:read` |
| [ProjectKmsGetCA](https://api.aiven.io/doc/#operation/ProjectKmsGetCA) | `organization:projects:write` |
| [ProjectUpdate](https://api.aiven.io/doc/#operation/ProjectUpdate) | `organization:projects:write` |

...
- [`opensearch_version`](#spec.userConfig.opensearch_version-property){: name='spec.userConfig.opensearch_version-property'} (string). Available versions: `1`, `2`, `2.19`, `3.3`, `3.6`. Newer versions may also be available.
    OpenSearch version.

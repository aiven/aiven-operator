...
- [`opensearch_version`](#spec.userConfig.opensearch_version-property){: name='spec.userConfig.opensearch_version-property'} (string). Available versions: `2`, `2.19`, `3.3`, `3.6`. Newer versions may also be available.
...
- [`max_restore_bytes_per_sec`](#spec.userConfig.azure_migration.max_restore_bytes_per_sec-property){: name='spec.userConfig.azure_migration.max_restore_bytes_per_sec-property'} (string, Pattern: `^\d+\s*(?:[bB]|[kKmMgGtTpP][bB])$`). Throttles the restore rate per node. Defaults to unlimited. Note that if the recovery settings for managed services are set, this value is overridden by the recovery settings. Value should be a byte size with unit, e.g. 40mb, 100kb, 1gb.
- [`max_snapshot_bytes_per_sec`](#spec.userConfig.azure_migration.max_snapshot_bytes_per_sec-property){: name='spec.userConfig.azure_migration.max_snapshot_bytes_per_sec-property'} (string, Pattern: `^\d+\s*(?:[bB]|[kKmMgGtTpP][bB])$`). Throttles the snapshot rate per node. Defaults to 40mb. Note that if the recovery settings for managed services are set, this value is overridden by the recovery settings. Value should be a byte size with unit, e.g. 40mb, 100kb, 1gb.
...
- [`max_restore_bytes_per_sec`](#spec.userConfig.gcs_migration.max_restore_bytes_per_sec-property){: name='spec.userConfig.gcs_migration.max_restore_bytes_per_sec-property'} (string, Pattern: `^\d+\s*(?:[bB]|[kKmMgGtTpP][bB])$`). Throttles the restore rate per node. Defaults to unlimited. Note that if the recovery settings for managed services are set, this value is overridden by the recovery settings. Value should be a byte size with unit, e.g. 40mb, 100kb, 1gb.
- [`max_snapshot_bytes_per_sec`](#spec.userConfig.gcs_migration.max_snapshot_bytes_per_sec-property){: name='spec.userConfig.gcs_migration.max_snapshot_bytes_per_sec-property'} (string, Pattern: `^\d+\s*(?:[bB]|[kKmMgGtTpP][bB])$`). Throttles the snapshot rate per node. Defaults to 40mb. Note that if the recovery settings for managed services are set, this value is overridden by the recovery settings. Value should be a byte size with unit, e.g. 40mb, 100kb, 1gb.
...
- [`cluster_max_shards_per_node`](#spec.userConfig.opensearch.cluster_max_shards_per_node-property){: name='spec.userConfig.opensearch.cluster_max_shards_per_node-property'} (integer, Minimum: 10, Maximum: 10000). Controls the number of shards allowed in the cluster per data node.
...
- [`http_max_content_length`](#spec.userConfig.opensearch.http_max_content_length-property){: name='spec.userConfig.opensearch.http_max_content_length-property'} (integer, Minimum: 1048576, Maximum: 2147483647). Maximum content length for HTTP requests to the OpenSearch HTTP API, in bytes.
...
- [`ml_commons_connector_access_control_enabled`](#spec.userConfig.opensearch.ml_commons_connector_access_control_enabled-property){: name='spec.userConfig.opensearch.ml_commons_connector_access_control_enabled-property'} (boolean). When set to true, the setting allows admins to control access and permissions to the connector API using backend_roles. Defaults to false.
- [`ml_commons_model_access_control_enabled`](#spec.userConfig.opensearch.ml_commons_model_access_control_enabled-property){: name='spec.userConfig.opensearch.ml_commons_model_access_control_enabled-property'} (boolean). Enable or disable model access control for ML Commons. When enabled, access to ML models is controlled by security permissions. Defaults to false.
- [`ml_commons_native_memory_threshold`](#spec.userConfig.opensearch.ml_commons_native_memory_threshold-property){: name='spec.userConfig.opensearch.ml_commons_native_memory_threshold-property'} (integer, Minimum: 1, Maximum: 100). Native memory threshold percentage for ML Commons. Controls the maximum percentage of native memory that can be used by ML Commons operations. Defaults to 90%.
- [`ml_commons_only_run_on_ml_node`](#spec.userConfig.opensearch.ml_commons_only_run_on_ml_node-property){: name='spec.userConfig.opensearch.ml_commons_only_run_on_ml_node-property'} (boolean). Enable or disable running ML Commons tasks only on ML nodes. When enabled, ML tasks will only execute on nodes designated as ML nodes. Defaults to true.
- [`ml_commons_trusted_connector_endpoints_regex`](#spec.userConfig.opensearch.ml_commons_trusted_connector_endpoints_regex-property){: name='spec.userConfig.opensearch.ml_commons_trusted_connector_endpoints_regex-property'} (array of strings, MaxItems: 50). Adds the trusted endpoints to the cluster settings. Supports Java regex expressions.
...
- [`window_size`](#spec.userConfig.opensearch.search.insights.top_queries.cpu.window_size-property){: name='spec.userConfig.opensearch.search.insights.top_queries.cpu.window_size-property'} (string, Pattern: `^\d+\s*(?:[dhms]|ms|micros|nanos)$`). Configure the window size of the top N queries. The value should be a time value with unit, e.g. 1m, 5s, 1h.
...
- [`window_size`](#spec.userConfig.opensearch.search.insights.top_queries.latency.window_size-property){: name='spec.userConfig.opensearch.search.insights.top_queries.latency.window_size-property'} (string, Pattern: `^\d+\s*(?:[dhms]|ms|micros|nanos)$`). Configure the window size of the top N queries. The value should be a time value with unit, e.g. 1m, 5s, 1h.
...
- [`session_keepalive`](#spec.userConfig.opensearch_dashboards.session_keepalive-property){: name='spec.userConfig.opensearch_dashboards.session_keepalive-property'} (boolean). Determines whether the session TTL resets (is “kept alive”) on each user activity. Optional. Default is true.
- [`session_ttl`](#spec.userConfig.opensearch_dashboards.session_ttl-property){: name='spec.userConfig.opensearch_dashboards.session_ttl-property'} (string, Pattern: `^\d+\s*(?:[dhms]|ms|micros|nanos)$`). Defines the time-to-live (TTL) for user sessions. The value should be a time value with unit, e.g. 1m, 5s, 1h, 3d, 100ms. Default is 1 hour.
...
- [`max_restore_bytes_per_sec`](#spec.userConfig.s3_migration.max_restore_bytes_per_sec-property){: name='spec.userConfig.s3_migration.max_restore_bytes_per_sec-property'} (string, Pattern: `^\d+\s*(?:[bB]|[kKmMgGtTpP][bB])$`). Throttles the restore rate per node. Defaults to unlimited. Note that if the recovery settings for managed services are set, this value is overridden by the recovery settings. Value should be a byte size with unit, e.g. 40mb, 100kb, 1gb.
- [`max_snapshot_bytes_per_sec`](#spec.userConfig.s3_migration.max_snapshot_bytes_per_sec-property){: name='spec.userConfig.s3_migration.max_snapshot_bytes_per_sec-property'} (string, Pattern: `^\d+\s*(?:[bB]|[kKmMgGtTpP][bB])$`). Throttles the snapshot rate per node. Defaults to 40mb. Note that if the recovery settings for managed services are set, this value is overridden by the recovery settings. Value should be a byte size with unit, e.g. 40mb, 100kb, 1gb.

...
- [`innodb_log_buffer_size`](#spec.userConfig.mysql.innodb_log_buffer_size-property){: name='spec.userConfig.mysql.innodb_log_buffer_size-property'} (integer, Minimum: 1048576, Maximum: 4294967296). The size in bytes of the buffer that InnoDB uses to write to the log files on disk.

...
- [`pg_version`](#spec.userConfig.pg_version-property){: name='spec.userConfig.pg_version-property'} (string). Available versions: `13`, `14`, `15`, `16`, `17`, `18`. Newer versions may also be available.
...
- [`io_workers`](#spec.userConfig.pg.io_workers-property){: name='spec.userConfig.pg.io_workers-property'} (integer, Minimum: 1, Maximum: 32). EXPERIMENTAL: Number of IO worker processes, for io_method=worker. Version 18 and up only. Changing this parameter causes a service restart.

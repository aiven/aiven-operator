...
| ----------- | ----------- |
| [ServiceDatabaseCreate](https://api.aiven.io/doc/#operation/ServiceDatabaseCreate) | `developer` or `operator` |
| [ServiceDatabaseDelete](https://api.aiven.io/doc/#operation/ServiceDatabaseDelete) | `developer` or `operator` |
| [ServiceDatabaseList](https://api.aiven.io/doc/#operation/ServiceDatabaseList) | `developer` or `operator`, or `read_only` |

...
- [`pg_version`](#spec.userConfig.pg_version-property){: name='spec.userConfig.pg_version-property'} (string, Enum: `12`, `13`, `14`, `15`, `16`, `17`). PostgreSQL major version. Deprecated values: `12`.
...
- [`log_level`](#spec.userConfig.pgaudit.log_level-property){: name='spec.userConfig.pgaudit.log_level-property'} (string, Enum: `warning`). Deprecated. Specifies the log level that will be used for log entries.

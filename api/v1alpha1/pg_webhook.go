...
//+kubebuilder:webhook:path=/mutate-k8s-operator-aiven-io-v1alpha1-pg,mutating=true,failurePolicy=fail,groups=k8s-operator.aiven.io,resources=pgs,verbs=create;update,versions=v1alpha1,name=mpg.kb.io,sideEffects=none,admissionReviewVersions=v1
...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-k8s-operator-aiven-io-v1alpha1-pg,mutating=false,failurePolicy=fail,groups=k8s-operator.aiven.io,resources=pgs,versions=v1alpha1,name=vpg.kb.io,sideEffects=none,admissionReviewVersions=v1

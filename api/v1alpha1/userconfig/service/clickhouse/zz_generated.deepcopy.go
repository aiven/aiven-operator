...
func (in *ClickhouseUserConfig) DeepCopyInto(out *ClickhouseUserConfig) {
	*out = *in
	...
	if in.SessionSettings != nil {
		in, out := &in.SessionSettings, &out.SessionSettings
...
func (in *ServerSettings) DeepCopyInto(out *ServerSettings) {
	*out = *in
	if in.VectorSimilarityIndexCacheSize != nil {
		in, out := &in.VectorSimilarityIndexCacheSize, &out.VectorSimilarityIndexCacheSize
		*out = new(float64)
		**out = **in
	}
}

...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomKeystores) DeepCopyInto(out *CustomKeystores) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomKeystores.
func (in *CustomKeystores) DeepCopy() *CustomKeystores {
	if in == nil {
		return nil
	}
	out := new(CustomKeystores)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomRepos) DeepCopyInto(out *CustomRepos) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomRepos.
func (in *CustomRepos) DeepCopy() *CustomRepos {
	if in == nil {
		return nil
	}
	out := new(CustomRepos)
...
func (in *OpensearchUserConfig) DeepCopyInto(out *OpensearchUserConfig) {
	*out = *in
	...
	if in.CustomKeystores != nil {
		...
		*out = make([]*CustomKeystores, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CustomKeystores)

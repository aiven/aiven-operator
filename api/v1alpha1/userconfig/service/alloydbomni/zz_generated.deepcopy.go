...
func (in *AlloydbomniUserConfig) DeepCopyInto(out *AlloydbomniUserConfig) {
	*out = *in
	...
	if in.AlloydbomniVersion != nil {
		in, out := &in.AlloydbomniVersion, &out.AlloydbomniVersion
		*out = new(string)
		**out = **in
	}
	...
	if in.GoogleColumnarEngineEnabled != nil {
		in, out := &in.GoogleColumnarEngineEnabled, &out.GoogleColumnarEngineEnabled
		*out = new(bool)
		**out = **in
	}
	if in.GoogleColumnarEngineMemorySizePercentage != nil {
		in, out := &in.GoogleColumnarEngineMemorySizePercentage, &out.GoogleColumnarEngineMemorySizePercentage
		*out = new(int)
		**out = **in
	}
	if in.IpFilter != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlloydbomniUserConfig.
func (in *AlloydbomniUserConfig) DeepCopy() *AlloydbomniUserConfig {
	if in == nil {
		return nil
	}
	out := new(AlloydbomniUserConfig)
	in.DeepCopyInto(out)
	return out
}

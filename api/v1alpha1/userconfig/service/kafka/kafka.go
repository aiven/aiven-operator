...
type SchemaRegistryConfig struct {
	...
	// +kubebuilder:validation:MaxLength=4096
	// Maps HTTP methods to allowed roles. Use a JSON object with `GET`, `POST`, `PUT`, and `DELETE` keys mapped to arrays of roles. Role names use the `karapace.` prefix. Example: `{"GET": ["karapace.schema:read"], "POST": [], "PUT": [], "DELETE": []}`.
...
type KafkaUserConfig struct {
	...
	// +kubebuilder:validation:Enum=12;24;3;4;6;8
	...
	// Available versions: `6.2.1`, `6.2.2`, `6.2.3`. Newer versions may also be available.

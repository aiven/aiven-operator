...
func (in *KafkaConnectUserConfig) DeepCopyInto(out *KafkaConnectUserConfig) {
	*out = *in
	...
	if in.PluginVersions != nil {
		in, out := &in.PluginVersions, &out.PluginVersions
		*out = make([]*PluginVersions, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PluginVersions)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PluginVersions) DeepCopyInto(out *PluginVersions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PluginVersions.
func (in *PluginVersions) DeepCopy() *PluginVersions {
	if in == nil {
		return nil
	}
	out := new(PluginVersions)

...
func (in *PgUserConfig) DeepCopyInto(out *PgUserConfig) {
	*out = *in
	...
	if in.SwitchoverWindows != nil {
		in, out := &in.SwitchoverWindows, &out.SwitchoverWindows
		*out = make([]*SwitchoverWindows, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(SwitchoverWindows)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SwitchoverWindows) DeepCopyInto(out *SwitchoverWindows) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SwitchoverWindows.
func (in *SwitchoverWindows) DeepCopy() *SwitchoverWindows {
	if in == nil {
		return nil
	}
	out := new(SwitchoverWindows)

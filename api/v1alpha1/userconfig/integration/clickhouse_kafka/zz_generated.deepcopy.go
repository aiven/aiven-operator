...
func (in *MaterializedView) DeepCopyInto(out *MaterializedView) {
	*out = *in
	...
	if in.EngineParams != nil {
		in, out := &in.EngineParams, &out.EngineParams
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.LocalDiskTtlDays != nil {
		in, out := &in.LocalDiskTtlDays, &out.LocalDiskTtlDays
		*out = new(int)
		**out = **in
	}
	if in.OrderBy != nil {
	...
	if in.TtlColumn != nil {
		in, out := &in.TtlColumn, &out.TtlColumn
		*out = new(string)
		**out = **in
	}
	if in.TtlDays != nil {

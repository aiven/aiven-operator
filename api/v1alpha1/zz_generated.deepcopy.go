...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KafkaConnectorConnectorSpecificConfig) DeepCopyInto(out *KafkaConnectorConnectorSpecificConfig) {
	{
		in := &in
		*out = make(KafkaConnectorConnectorSpecificConfig, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaConnectorConnectorSpecificConfig.
func (in KafkaConnectorConnectorSpecificConfig) DeepCopy() KafkaConnectorConnectorSpecificConfig {
	if in == nil {
		return nil
	}
	out := new(KafkaConnectorConnectorSpecificConfig)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *KafkaConnectorSpec) DeepCopyInto(out *KafkaConnectorSpec) {
	*out = *in
	if in.ConnectorSpecificConfig != nil {
		in, out := &in.ConnectorSpecificConfig, &out.ConnectorSpecificConfig

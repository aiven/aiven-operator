...
func (in *ConnectionPoolStatus) DeepCopyInto(out *ConnectionPoolStatus) {
	*out = *in
	out.ConnectionPoolSpec = in.ConnectionPoolSpec
}
...
func (in *KafkaACLStatus) DeepCopyInto(out *KafkaACLStatus) {
	*out = *in
	out.KafkaACLSpec = in.KafkaACLSpec
}
...
func (in *KafkaConnectStatus) DeepCopyInto(out *KafkaConnectStatus) {
	*out = *in
	in.KafkaConnectSpec.DeepCopyInto(&out.KafkaConnectSpec)
}
...
func (in *KafkaSchemaStatus) DeepCopyInto(out *KafkaSchemaStatus) {
	*out = *in
	out.KafkaSchemaSpec = in.KafkaSchemaSpec
}
...
func (in *KafkaSpec) DeepCopyInto(out *KafkaSpec) {
	*out = *in
	out.ServiceCommonSpec = in.ServiceCommonSpec
	out.AuthSecretRef = in.AuthSecretRef
	out.SecretCoonInfo = in.SecretCoonInfo
...
func (in *KafkaStatus) DeepCopyInto(out *KafkaStatus) {
	*out = *in
	in.KafkaSpec.DeepCopyInto(&out.KafkaSpec)
}
...
func (in *KafkaTopicStatus) DeepCopyInto(out *KafkaTopicStatus) {
	*out = *in
	in.KafkaTopicSpec.DeepCopyInto(&out.KafkaTopicSpec)
}
...
func (in *ProjectVPCStatus) DeepCopyInto(out *ProjectVPCStatus) {
	*out = *in
	out.ProjectVPCSpec = in.ProjectVPCSpec
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretConnectionInfo) DeepCopyInto(out *SecretConnectionInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretConnectionInfo.
func (in *SecretConnectionInfo) DeepCopy() *SecretConnectionInfo {
	if in == nil {
		return nil
	}
	out := new(SecretConnectionInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceIntegrationStatus) DeepCopyInto(out *ServiceIntegrationStatus) {
	*out = *in
	in.ServiceIntegrationSpec.DeepCopyInto(&out.ServiceIntegrationSpec)
}
...
func (in *ServiceUserStatus) DeepCopyInto(out *ServiceUserStatus) {
	*out = *in
	out.ServiceUserSpec = in.ServiceUserSpec
}

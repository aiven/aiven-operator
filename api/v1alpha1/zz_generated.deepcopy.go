...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaServiceKafkaConnectUserConfig) DeepCopyInto(out *KafkaServiceKafkaConnectUserConfig) {
	*out = *in
	if in.ConsumerFetchMaxBytes != nil {
		in, out := &in.ConsumerFetchMaxBytes, &out.ConsumerFetchMaxBytes
		*out = new(int64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaServiceKafkaConnectUserConfig.
func (in *KafkaServiceKafkaConnectUserConfig) DeepCopy() *KafkaServiceKafkaConnectUserConfig {
	if in == nil {
		return nil
	}
	out := new(KafkaServiceKafkaConnectUserConfig)
	in.DeepCopyInto(out)
	return out
}

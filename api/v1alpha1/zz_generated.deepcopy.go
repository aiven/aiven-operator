...
func (in *ClickhouseDatabaseSpec) DeepCopyInto(out *ClickhouseDatabaseSpec) {
	*out = *in
	out.ProjectServiceFields = in.ProjectServiceFields
	if in.AuthSecretRef != nil {
		in, out := &in.AuthSecretRef, &out.AuthSecretRef
		*out = new(AuthSecretReference)
		**out = **in
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProjectServiceFields) DeepCopyInto(out *ProjectServiceFields) {
	*out = *in
	out.ProjectField = in.ProjectField
	out.ServiceField = in.ServiceField
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProjectServiceFields.
func (in *ProjectServiceFields) DeepCopy() *ProjectServiceFields {
	if in == nil {
		return nil
	}
	out := new(ProjectServiceFields)
	in.DeepCopyInto(out)
	return out
}

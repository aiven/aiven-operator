...
func (in *Grafana) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
...
func (in *Grafana) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	grafanalog.Info("validate update", "name", in.Name)

	if in.Spec.Project != oldObj.(*Grafana).Spec.Project {
		return nil, errors.New("cannot update a Grafana service, project field is immutable and cannot be updated")
	}

	if in.Spec.ConnInfoSecretTarget.Name != oldObj.(*Grafana).Spec.ConnInfoSecretTarget.Name {
		return nil, errors.New("cannot update a Grafana service, connInfoSecretTarget.name field is immutable and cannot be updated")
	}
...
func (in *Grafana) ValidateDelete(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {

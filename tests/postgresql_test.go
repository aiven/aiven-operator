...
func TestPgReadReplica(t *testing.T) {
	...
	assert.Contains(t, serviceRunningStatesAiven, master.Status.State)
	...
	assert.Contains(t, serviceRunningStatesAiven, replica.Status.State)
...
func TestPgCustomPrefix(t *testing.T) {
	...
	assert.Contains(t, serviceRunningStatesAiven, pg.Status.State)
